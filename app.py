...
href = f'<a href="data:file/csv;base64,{b64}" download="filtered_results.csv" style="display: inline-block; padding: 10px 20px; font-size: 16px; font-weight: bold; color: white; background-color: #ff4b4b; text-decoration: none; border-radius: 5px; text-align: center;">⬇ Download CSV</a>'
